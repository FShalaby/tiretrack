...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.POST, "/api/payroll/shift-slots/{slotId}/employees/{employeeId}")
                        .hasAnyRole("SUPER_ADMIN", "OWNER", "ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/api/payroll/shift-slots/{slotId}/signups/{signupId}")
                        .hasAnyRole("SUPER_ADMIN", "OWNER", "ADMIN")
                ...
                .requestMatchers(HttpMethod.GET, "/api/payroll/employees/{employeeId}/records")
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList(
                "http://localhost:5173",
                "https://tiretrack-murex.vercel.app"
        ));
